...
<?php require_once __DIR__ . '/partials/nav.view.php'; ?>
    ...
    <div class="page-container">
        ...
        <?php if (!empty($errors)): ?>
            <div class="alert alert-error"><span><?php echo $errors[0] ?? 'Please fix the errors below.'; ?></span></div>
        <?php endif; ?>
        <?php if (!empty($unavailable_items)): ?>
            <div class="alert alert-warning"><span>Some items are unavailable. Please <a href="<?php echo url('/cart.php'); ?>" style="color:#975a16;font-weight:600;">update your cart</a>.</span></div>
        <?php endif; ?>
            ...
            <div class="checkout-layout">
                <div class="checkout-form-section">
                    <div class="checkout-card">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (isset($errors['shipping_address'])): ?><div class="error-message show"><?php echo $errors['shipping_address']; ?></div><?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="checkout-card">
                        ...
                        <div class="payment-options">
                            ...
                            <label class="payment-option <?php echo $pm === 'cash_on_delivery' ? 'selected' : ''; ?>"><input type="radio" name="payment_method" value="cash_on_delivery" <?php echo $pm === 'cash_on_delivery' ? 'checked' : ''; ?>><div class="payment-info"><strong>Cash on Delivery</strong><span>Pay when you receive your order</span></div></label>
                            <label class="payment-option <?php echo $pm === 'bank_transfer' ? 'selected' : ''; ?>"><input type="radio" name="payment_method" value="bank_transfer" <?php echo $pm === 'bank_transfer' ? 'checked' : ''; ?>><div class="payment-info"><strong>Bank Transfer</strong><span>Direct bank deposit</span></div></label>
                            <label class="payment-option <?php echo $pm === 'gcash' ? 'selected' : ''; ?>"><input type="radio" name="payment_method" value="gcash" <?php echo $pm === 'gcash' ? 'checked' : ''; ?>><div class="payment-info"><strong>GCash</strong><span>Pay via GCash e-wallet</span></div></label>
                            <label class="payment-option <?php echo $pm === 'credit_card' ? 'selected' : ''; ?>"><input type="radio" name="payment_method" value="credit_card" <?php echo $pm === 'credit_card' ? 'checked' : ''; ?>><div class="payment-info"><strong>Credit/Debit Card</strong><span>Visa, Mastercard (simulated)</span></div></label>
                        </div>
                    </div>
                ...
                <div class="checkout-summary">
                    <div class="checkout-card sticky-summary">
                        ...
                        <button type="submit" class="btn-place-order" <?php echo !empty($unavailable_items) ? 'disabled' : ''; ?>>Place Order</button>
                        <p class="order-note">No real payment will be processed.</p>
                        <a href="<?php echo url('/cart.php'); ?>" class="btn-back-to-cart">Back to Cart</a>
                    </div>
                </div>
            </div>
        </form>
