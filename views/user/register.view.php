        ...
        <div class="auth-card">
            ...
            <form method="POST" action="" id="registerForm" novalidate>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['full_name'])): ?><div class="error-message show"><?php echo $errors['full_name']; ?></div>
                    <?php else: ?><div class="error-message" id="full_name_error"><span></span></div><?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['email'])): ?><div class="error-message show"><?php echo $errors['email']; ?></div>
                    <?php else: ?><div class="error-message" id="email_error"><span></span></div><?php endif; ?>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <?php if (isset($errors['phone'])): ?><div class="error-message show"><?php echo $errors['phone']; ?></div><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['address'])): ?><div class="error-message show"><?php echo $errors['address']; ?></div><?php endif; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['password'])): ?><div class="error-message show"><?php echo $errors['password']; ?></div>
                    <?php else: ?><div class="error-message" id="password_error"><span></span></div><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <?php if (isset($errors['confirm_password'])): ?><div class="error-message show"><?php echo $errors['confirm_password']; ?></div>
                    <?php else: ?><div class="error-message" id="confirm_password_error"><span></span></div><?php endif; ?>
                </div>
