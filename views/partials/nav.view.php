    <header class="header">
        <div class="container">
            <a href="<?php echo url('/index.php'); ?>" class="brand">E-Store</a>
            <nav class="nav-store">
                ...
                <a href="<?php echo url('/cart.php'); ?>" <?php echo ($activePage ?? '') === 'cart' ? 'class="active"' : ''; ?>>Cart<?php echo isset($cart_count) && $cart_count > 0 ? " ($cart_count)" : ''; ?></a>
                <div class="nav-user">
                    <?php if (isLoggedIn()): ?>
